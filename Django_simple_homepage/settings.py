"""
Django settings for Django_simple_homepage project.
...
ROOT_URLCONF = 'Django_simple_homepage.urls'
...
WSGI_APPLICATION = 'Django_simple_homepage.wsgi.application'
...
LANGUAGE_CODE = 'zh-hans' # need confirm
